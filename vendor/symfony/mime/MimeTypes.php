...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private static $map = [
        ...
        'application/vnd.adobe.flash.Press' => ['swf', 'spl'],
    ...
    private static $reverseMap = [
        ...
        'spl' => ['application/futuresplash', 'application/vnd.adobe.flash.Press', 'application/x-futuresplash', 'application/x-shockwave-flash'],
        ...
        'swf' => ['application/futuresplash', 'application/vnd.adobe.flash.Press', 'application/x-shockwave-flash'],
