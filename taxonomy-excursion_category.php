                ...
                <div class="wrapper">
                    ...
                    <div class="wrap">
                        <div class="_12 _m8">
                            ...
                            <a class="a-link -underline -gray" href="<?php echo $before_left_link['url'] ?>"><?php echo $before_left_link['title'] ?></a>
                        </div>
                        <div class="_12 _m4">
                            ...
                            <a class="a-link -underline -gray" href="<?php echo $before_right_link['url'] ?>"><?php echo $before_right_link['title'] ?></a>
                        </div>
                    </div>
                </div>
            </section>
