                        ...
                        <div class="wrap">
                                ...
                                <?php if (have_rows('content')) : ?>
                                    <?php while (have_rows('content')) : the_row();
                                        ...
                                        elseif (get_row_layout() == 'images') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-images.php');
                                        elseif (get_row_layout() == 'list') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-list.php');
                                        elseif (get_row_layout() == 'gallery') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-slider.php');
                                        elseif (get_row_layout() == 'awards') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-awards.php');
                                        elseif (get_row_layout() == 'video') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-video.php');
                                        ...
                                        elseif (get_row_layout() == 'brochure') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-brochure.php');
                                        elseif (get_row_layout() == 'bookings') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-bookings.php');
                                        elseif (get_row_layout() == 'cruising') :
                                            include(get_template_directory() . '/template-parts/inner/_acf-cruising.php');
                            ...
                            <div class="_l3">
                                <nav class="side-navigation" role="navigation">
                                    ...
                                    <?php wp_nav_menu(array('menu' => 'Side Menu', 'menu_class' => 'menu side-menu')); ?>
                                </nav>
                            </div>
                        </div>
                    </div>
