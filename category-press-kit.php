                    ...
                    <div class="_l9">
                        <div class="wrap">
                            ...
                            while( $query->have_posts()): $query->the_post();
                                $content = get_field('tcontent', get_the_ID());
                                $link = get_field('download',get_the_ID());?>
                                <div class="_12 -pressKit">
                                    <p class="a-text -offers -date"><?php echo get_the_date( 'd M Y' );?></p>
                                    <?php the_title( '<h4 class="a-title -kit">', '</h4>' );?>
                                    <div class="a-text -staff"><?= $content; ?></div>
                                        <a href="<?php the_permalink() ?>" class="a-link inverse">Read More</a>
